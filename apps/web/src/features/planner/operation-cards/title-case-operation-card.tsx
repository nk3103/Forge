...
import type { TitleCaseOperation } from "@/features/operations/operation-types";

interface TitleCaseOperationCardProps {
  operation: TitleCaseOperation;
  explanation: string;
}

export function TitleCaseOperationCard({
  operation,
  explanation,
}: TitleCaseOperationCardProps) {
